...
* **The Impact:** The warehouse suffered from inventory bloat, paying high holding costs for slow-moving "dead stock," while frequently facing stockouts on high-margin products. They were treating all inventory equally rather than prioritizing based on actual revenue contribution.

### 3. Stagnant Average Order Value (AOV)
* **The Issue:** The e-commerce platform had no intelligent recommendation engine. Customers frequently checked out with single items in their carts.
* **The Impact:** The company was leaving significant revenue on the table. Without knowing which products had high purchasing affinity (e.g., customers who buy laptops also buy mice), the business could not effectively bundle items or cross-sell at checkout.
...
## 🎯 Project Objective
The objective of the Project Alpha Analytics Engine is to transform raw, transactional SQL data into a strategic command center. By engineering advanced T-SQL models and deploying an interactive Power BI dashboard, this project aims to:
